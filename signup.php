<?php 
 ...
 if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if(!empty($mail) && !empty($password) &&!is_numeric($mail)){
        $query = "insert into form(name,mail,pass) values('$name', '$mail', '$password')";
    ...
    echo"<script type='text/javascript' alert('please enter valid infomation')</script>";
 }
?>
...
<body>
    <div class="container1 mx-auto"  >
     ...
     <div>
      <main class="min-h-screen" style="background-image: url(/pic3.webp); background-size: cover;">
         <div class="loginpg">
